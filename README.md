...
This would be initially a command line tool based on python script. 
In future it is planned to use standalone windows executable and then a proper website based on feedback and demand.
