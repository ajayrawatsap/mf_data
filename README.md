...
5. Install the latest [python](https://www.python.org/downloads/)  version 3.9 and required libraries.
   See [requirements.txt ](/requirements.txt) for additional python libraries required and install them using pip command. For additional info on installing packages see     [documentaion ](https://docs.python.org/3/installing/index.html_
